...
function getFsContentsForAlternateResultAtTypesPackageJson(packageName: string, addTypesCondition: boolean) {
...
function getSysForAlternateResult(forTsserver: boolean) {
    return TestServerHost.getCreateWatchedSystem(forTsserver)({
        "/home/src/projects/project/node_modules/@types/bar/package.json": getFsContentsForAlternateResultAtTypesPackageJson("bar", /*addTypesCondition*/ false),
        ...
        "/home/src/projects/project/node_modules/@types/bar2/package.json": getFsContentsForAlternateResultAtTypesPackageJson("bar2", /*addTypesCondition*/ true),
    ...
    action(
        ...
        () => [
            ...
            },
            {
                ...
                edit: sys => sys.writeFile("/home/src/projects/project/node_modules/@types/bar/package.json", getFsContentsForAlternateResultAtTypesPackageJson("bar", /*addTypesCondition*/ true)),
                timeouts: sys => {
                    sys.runQueuedTimeoutCallbacks();
                    sys.runQueuedTimeoutCallbacks();
                },
            ...
            },
            {
                ...
                edit: sys => sys.writeFile("/home/src/projects/project/node_modules/@types/bar2/package.json", getFsContentsForAlternateResultAtTypesPackageJson("bar2", /*addTypesCondition*/ false)),
                timeouts: sys => {
                    sys.runQueuedTimeoutCallbacks();
                    sys.runQueuedTimeoutCallbacks();
                },
            ...
            {
                caption: "add the node10Result in package/types",
