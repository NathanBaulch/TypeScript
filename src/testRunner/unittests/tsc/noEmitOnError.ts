        ...
        edits: [
            {
                ...
                discrepancyExplanation: () => [
                    ...
                    `Incremental build will also have emitSignatureDtsMapDiffers for both files since the emitSignatures were without declarationMap but currentOptions have declarationMap`,
                ],
            },
            {
